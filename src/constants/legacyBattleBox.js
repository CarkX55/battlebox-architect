...
export function inferStrategyFromArchetype(archetypeId, currentStrategyId, promptText = '') {
  ...
  if (stringToAnalyze.includes('tokens') || stringToAnalyze.includes('token') || stringToAnalyze.includes('fichas') || stringToAnalyze.includes('enjambre') || stringToAnalyze.includes('convoke') || stringToAnalyze.includes('saprolin') || stringToAnalyze.includes('saproling') || stringToAnalyze.includes('hongo') || stringToAnalyze.includes('fungus') || stringToAnalyze.includes('espora')) return 'tokens';
