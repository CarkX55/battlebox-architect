      ...
      >
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-4 shrink-0">
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-cinzel text-grimorio-gold flex items-center justify-center md:justify-start gap-8">
              <img src="/ASSETS/ManoDragon.webp" alt="Mano Dragon" className="w-32 h-32 object-contain drop-shadow-[0_0_35px_rgba(255,202,88,0.6)]" />
